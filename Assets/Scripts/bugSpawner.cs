...
public class bugSpawner : MonoBehaviour
{
    ...
    [SerializeField] GameObject objectToSpawn;  // Assign Bug prefab here
    ...
    void Start()
    {
        gamemanager.instance.updateGameGoal(spawnAmount, false, true); // Bug count update
    }
    ...
    void Spawn()
    {
        ...
        {
            Debug.LogError("No spawn positions assigned to bugSpawner!");
            return;
        }
