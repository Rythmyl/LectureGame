...
public class bugAI : MonoBehaviour, IDamage
{
    [Header("----- Components -----")]
    ...
    [Header("----- Stats -----")]
    [Range(30, 300)][SerializeField] int HP;
    ...
    void Start()
    {
        ...
        if (weaponCol == null)
        {
            Debug.LogError("Weapon Collider is not assigned in the inspector!");
        }
        else
        {
    ...
    public void takeDamage(int amount)
    {
        ...
        {
            isDead = true;
            gamemanager.instance.updateGameGoal(-1, false, true);
